...
const ExpiryPolicyService = async (datefrom = "2019-01-01", dateto = "2019-08-19", cob) => {
  const { wsUrl, wsExpiryPolicy, type, KEY_DATA_USER } = Constants;
  ...
  const envelope = await setEnvelope(wsExpiryPolicy, data);
  let result;
