    ...
    <View style={{flex: 1, alignItems: 'center'}}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.menuRow}>
          ...
          <TouchableOpacity style={styles.card} onPress={() => onMenuPress('MNC Care')}>
            <View style={{flex: 1}}>
              <View style={styles.iconContainer}>
                <Image
                  resizeMode="contain"
                  style={styles.icon}
                  source={require('../assets/icons/MNCCare.png')}
                />
              </View>
              <View
                style={{
                ...
                <Text style={styles.textTitle}>MNC Care</Text>
              </View>
            </View>
          </TouchableOpacity>
